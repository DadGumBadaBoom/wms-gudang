...
<head>
    ...
    <title>Edit User - WMS Gudang</title>
    ...
    <div class="container">
        <div class="form-card">
            <div class="form-header text-center">
                ...
                ?>
                <a href="<?= base_url('user/admin?key=' . $currentKey) ?>" class="back-link mt-3 d-inline-block">
            ...
            <div class="p-4">
                ...
                <form action="<?= base_url('user/update/' . $user['id_user'] . '?key=' . $currentKey) ?>" method="post">
                    <?= csrf_field() ?>
